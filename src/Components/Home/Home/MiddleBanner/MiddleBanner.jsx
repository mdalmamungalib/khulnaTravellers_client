    ...
    <div className="mt-24">
      <section
        ...
        <div
         ...
         rtl:sm:bg-gradient-to-l"></div>

        <div className="relative max-w-screen-xl px-4 py-32 sm:px-6 lg:flex 
        lg:h-screen lg:items-center lg:px-8">
          <div className="max-w-xl  ltr:sm:text-left rtl:sm:text-right">
            ...
            <p className="mt-4 max-w-lg text-black sm:text-xl/relaxed">
              ...
              elit. Nesciunt illo tenetur fuga ducimus numquam
              ea!
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-4 text-center">
              <Link to={"/destination"}>
              <a
                className="block w-full rounded bg-rose-600 border-none px-12 py-3 text-sm font-medium text-white shadow hover:bg-rose-700 focus:outline-none focus:ring active:bg-rose-500 sm:w-auto">
                View All Tour
              </a>
              </Link>
            </div>
